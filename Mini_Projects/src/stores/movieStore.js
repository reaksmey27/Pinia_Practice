...
const MOVIES = [
  ...
  },
  {
    ...
    year: 2008,
    rating: 9.0,
    description: 'Batman faces the Joker, a criminal mastermind who terrorizes Gotham City.',
  ...
  },
  {
    ...
    year: 1994,
    rating: 8.9,
    description: 'Lives of two mob hitmen, a boxer, and a gangster intertwine.',
  ...
  },
  {
    ...
    year: 1994,
    rating: 8.8,
    description: 'The presidencies of Kennedy and Nixon through the eyes of an Alabama man.',
...
export const useMovieStore = defineStore('movies', () => {
  ...
  const allGenres = computed(() => {
    const genres = movies.value.map((m) => m.genre)
